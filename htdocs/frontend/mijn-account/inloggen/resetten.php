  ...
  <section>
    ...
    <div class="login-box">
      <h2>Wachtwoord resetten</h2>
        ...
        <form action="../../../backend/accounts/update-wachtwoord.php" method="post">
            <!-- Hidden input for the token -->
            <input type="hidden" name="token" value="<?php echo $_GET['token']; ?>" />

            <div class="email-input">
                <input type="password" id="password" name="password" placeholder="Nieuw wachtwoord" required /><br>
            </div>
            <div class="email-input">
                <input type="password" id="confirm_password" name="confirm_password" placeholder="Bevestig wachtwoord" required /><br>
            </div>
            <div class="links">
