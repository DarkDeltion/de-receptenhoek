...
<body>
    <section>
        ...
        <!-- Verplaatst de message container hier -->
        <div id="message" style="display: none; padding: 10px; margin-top: 20px; margin-bottom: -10px; margin-left: 0px; margin-right: 0px; border-radius: 5px; text-align: center;"></div>
        ...
        <div class="login-box">
            ...
            <form action="../../../backend/accounts/registreren.php" method="post">
                ...
                <div class="password-input">
                    ...
                    <input type="password" id="confirm_password" name="confirm_password" placeholder="Password Again" required><br>
                </div>
                <div class="links">
